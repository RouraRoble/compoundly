...
Compare up to three savings or investing scenarios side by side, with the whole comparison in a link.
Static Astro site (Preact island for the calculator), deployed to GitHub Pages. See `PRODUCT.md` for data
sources, formulas and monetization hooks, and `STATUS.md` for build/test status.

---

Below: the shared template documentation this product was scaffolded from.
