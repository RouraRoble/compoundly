...
// Third-party origins are only allowed when the corresponding feature is enabled at build time
// (repo variables) — ported from foundation/template so AdSense/Plausible work once configured,
// without loosening the CSP for every build that doesn't set them.
